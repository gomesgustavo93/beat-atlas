...
import { isAuthenticated as isAuthenticatedService, getUserProfile as getUserProfileService } from '../../services/oauthService';
import type { IUserState, TUserAction, IUserProfile, IUserContextType } from './UserContext.types';
...
export function UserProvider({ children }: { children: ReactNode }) {
    ...
    const fetchUserProfile = useCallback(async () => {
        ...
        try {
            ...
            dispatch({
                type: 'FETCH_ERROR',
                payload: error instanceof Error ? error.message : 'Erro ao buscar perfil do usuário',
            });
        }
    }, []);
